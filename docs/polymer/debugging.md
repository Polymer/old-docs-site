...
In Chrome, the DOM created looks like this:
...
`$0` is a console variable that refers to the currently selected element. It's supported in most browsers.
...
When working with [data binding](https://www.polymer-project.org/docs/polymer/databinding.html), a lot of data is available if you know where to look. The examples in this section show DevTools, but with minor modifications, will work in Firefox, 

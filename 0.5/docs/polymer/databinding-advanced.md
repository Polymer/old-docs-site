...
In general, **you shouldn’t need to manually mutate the DOM nodes generated by template bindings**—you 
can do most things you need to do simply by setting up bindings and mutating the model object.

...
Provided you use string literals to identify your dynamic imports, the Polymer 3.0 build tools will find them and include them in your build. You don't have to include them in a list of fragments.

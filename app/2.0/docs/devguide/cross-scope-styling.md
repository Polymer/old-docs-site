...
For example, the [paper-checkbox element](https://elements.polymer-project.org/elements/paper-checkbox) provides custom properties for styling the colors, spacing and size of the checkbox and its label. 
...
[See it on JSBin](https://jsbin.com/yusuta/edit?html,output)
...
[See it on JSBin](https://jsbin.com/ruliruy/edit?html,output)
...
An element author can define a set of CSS properties as a single custom property and
...
Mixins let you define a set of CSS properties as a single custom property, and allow all properties in the set to be applied to a CSS rule in an element's local DOM.

...
If you have configured a custom hostname on your machine, polymer can serve it with the
`--hostname` argument (e.g. app project demo is available at `http://test:8080`):

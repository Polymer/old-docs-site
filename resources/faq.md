...
Nope! [{{site.project_title}} Designer](http://polymer-designer.appspot.com) is primarily a tool to make it easy to dive in and prototype apps. It's entirely optional&mdash;although we've found that for developers who use it, it has quickly become an indispensable part of their workflow.
...
One of our core goals is for {{site.project_title}} to work on modern mobile browsers as a first-class citizen. Check out [Topeka](http://polymer-topeka.appspot.com), one of our sample apps, to see it in action.
